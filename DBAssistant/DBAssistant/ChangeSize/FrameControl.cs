...
namespace CommonLib
{
    public partial class FrameControl : UserControl
    {
        ...
        private Point lastPoint; //上个鼠标坐标
        ...
        private void ControlMove()
        {
            ...
            int x = cPoint.X - lastPoint.X;
            int y = cPoint.Y - lastPoint.Y;
            //lblMsg.Text = $" baseControl.Height:{ baseControl.Height}  cPoint:{cPoint} pPoint:{lastPoint}";
            switch (this.mpoc)
            {
                ...
                case MousePosOnCtrl.BOTTOM:
                    ...
                    {
                        baseControl.Height += y;
                        //baseControl.Size = new Size(baseControl.Width, baseControl.Height + y);
                    }
                    else
                    {
                        baseControl.Height = MinHeight;
        ...
        private void FrameControl_Load(object sender, System.EventArgs e)
        {
